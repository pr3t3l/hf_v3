...
// No longer importing FamilyMember here
...
class Family {
  ...
  final List<String> memberUserIds; // List of registered user UIDs
  ...
  factory Family.fromFirestore(DocumentSnapshot<Map<String, dynamic>> doc) {
    ...
    return Family(
      ...
      memberUserIds: List<String>.from(data['memberUserIds'] ?? []), // Changed
      unregisteredMembers:
  ...
  Map<String, dynamic> toFirestore() {
    return {
      ...
      'memberUserIds': memberUserIds, // Changed
      'unregisteredMembers':
